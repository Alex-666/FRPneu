...
if (!extension_loaded('mbstring')) {
 	die('Warning: Multibyte String extension needs to be loaded for Responsive Filemanager to work! <a href="http://php.net/manual/en/mbstring.installation.php" target="_blank">Installation instructions</a>');
}

if (!extension_loaded('fileinfo')) {
 	die('Warning: FileInfo extension needs to be loaded for Responsive Filemanager to work! <a href="http://php.net/manual/en/fileinfo.installation.php" target="_blank">Installation instructions</a>');
}
...
$config = array(
	...
	*******************/
	...
	'hidden_folders'                          => array('cache', 'thumbs'),
	// set the names of any files you want hidden. Remember these names will be hidden in all folders (eg "this_document.pdf", "that_image.jpg" )
	'hidden_files'                            => array( 'config.php', 'index.html', 'no_image.png' ),
