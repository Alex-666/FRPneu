...
<div id="content">
<form action="<?php echo $action; ?>" method="post" id="form-magicslideshow" name="form-magicslideshow" class="form-horizontal">
    <div class="page-header">
	<div class="container-fluid">
	    <div class="pull-right">
		<button type="submit" form="form-magicslideshow" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <ul class="nav nav-tabs" <?php if (count($blocks) < 2) echo ' style="display:none;"'?>>
	...
	<div class="tab-pane  active" id="tab-general">
		...
		<div class="panel-body">
			...
			<label class="col-sm-2 control-label" for="magicslideshowsettingStatus">Enable/Disable module</label>
			<div class="col-sm-10">
			  <select name="magicslideshow_status" class="form-control">
				<option value="1" <?php echo (($magicslideshow_status) ? 'selected' : ''); ?> ><?php echo $text_enabled; ?></option>
				<option value="0" <?php echo ((!$magicslideshow_status) ? 'selected' : ''); ?> ><?php echo $text_disabled; ?></option>
			  </select>
			  <input type="hidden" name="magicslideshow_status_was" value="<?php echo $magicslideshow_status; ?>">
			</div>
		    </div>
	    ...
	    <div class="panel panel-default">
		    ...
		    <div class="panel-body">
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicslideshowsettingChache-path">Path to cache folder</label>
				<div class="col-sm-10">
				...
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicslideshowsettingTotal-items">Total items</label>
				<div class="col-sm-10">
						<input class="form-control" type="text" size="60" value="<?php echo $total_items; ?>" disabled="disabled" />
				</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicslideshowsettingUnuser-items">Unused items</label>
				<div class="col-sm-10">
						<input class="form-control" type="text" size="60" value="<?php echo $unused_items; ?>" disabled="disabled" />
				</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label" for="magicslideshowsettingEmpte-chache">Empty cache</label>
				<div class="col-sm-10">
