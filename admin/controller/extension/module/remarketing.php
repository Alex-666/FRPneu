...
class ControllerExtensionModuleRemarketing extends Controller {
	private $error = [];
	private $purchased_domain = 'https://www.frpneu.cz/';
	private $order = '77810';
	private $seller = 'liveopencart'; 
	private $version = '5.0'; 
	...
	public function index() {
		...
		$data['text_retail_rocket'] = $this->language->get('text_retail_rocket');
		...
		$data['entry_google_gtag_status'] = $this->language->get('entry_google_gtag_status');
		...
		$data['entry_retailrocket_email_field'] = $this->language->get('entry_retailrocket_email_field');
		$data['entry_retailrocket_identifier'] = $this->language->get('entry_retailrocket_identifier');
		...
		if (isset($this->request->post['remarketing_retailrocket_status'])) {
			$data['remarketing_retailrocket_status'] = $this->request->post['remarketing_retailrocket_status'];
		} else {
			$data['remarketing_retailrocket_status'] = $this->config->get('remarketing_retailrocket_status');
		}
		...
		if (isset($this->request->post['remarketing_facebook_log'])) {
			$data['remarketing_facebook_log'] = $this->request->post['remarketing_facebook_log'];
		} else {
			$data['remarketing_facebook_log'] = $this->config->get('remarketing_facebook_log');
		}
		...
		if (isset($this->request->post['remarketing_google_gtag_status'])) {
			$data['remarketing_google_gtag_status'] = $this->request->post['remarketing_google_gtag_status'];
		} else {
			$data['remarketing_google_gtag_status'] = $this->config->get('remarketing_google_gtag_status');
		}
		...
		if (isset($this->request->post['remarketing_retailrocket_identifier'])) {
			$data['remarketing_retailrocket_identifier'] = $this->request->post['remarketing_retailrocket_identifier'];
		} else {
			$data['remarketing_retailrocket_identifier'] = $this->config->get('remarketing_retailrocket_identifier');
		}

		if (isset($this->request->post['remarketing_retailrocket_email_field'])) {
			$data['remarketing_retailrocket_email_field'] = $this->request->post['remarketing_retailrocket_email_field'];
		} elseif($this->config->get('remarketing_retailrocket_email_field')) {
			$data['remarketing_retailrocket_email_field'] = $this->config->get('remarketing_retailrocket_email_field');
		} else {
			$data['remarketing_retailrocket_email_field'] = '#input-payment-email,#customer_email,#input-email';
		}
		...
		if (isset($this->request->post['remarketing_facebook_api_ver'])) {
			...
			$data['remarketing_facebook_api_ver'] = '11.0';
		}
		...
		if (isset($this->request->post['remarketing_ecommerce_measurement_log'])) {
			$data['remarketing_ecommerce_measurement_log'] = $this->request->post['remarketing_ecommerce_measurement_log'];
		} else {
			$data['remarketing_ecommerce_measurement_log'] = $this->config->get('remarketing_ecommerce_measurement_log');
		}

		if (isset($this->request->post['remarketing_ecommerce_ga4_measurement_log'])) {
			$data['remarketing_ecommerce_ga4_measurement_log'] = $this->request->post['remarketing_ecommerce_ga4_measurement_log'];
		} else {
			$data['remarketing_ecommerce_ga4_measurement_log'] = $this->config->get('remarketing_ecommerce_ga4_measurement_log');
		}
		...
		if (isset($this->request->post['remarketing_ecommerce_ga4_measurement_selector'])) {
			$data['remarketing_ecommerce_ga4_measurement_selector'] = $this->request->post['remarketing_ecommerce_ga4_measurement_selector'];
		} elseif ($this->config->get('remarketing_ecommerce_ga4_measurement_selector')) {
			$data['remarketing_ecommerce_ga4_measurement_selector'] = $this->config->get('remarketing_ecommerce_ga4_measurement_selector');
		} else {
			$data['remarketing_ecommerce_ga4_measurement_selector'] = '.product-thumb';
		}
		...
		if (isset($this->request->post['remarketing_ecommerce_resend_status'])) {
			$data['remarketing_ecommerce_resend_status'] = $this->request->post['remarketing_ecommerce_resend_status'];
		} else {
			$data['remarketing_ecommerce_resend_status'] = $this->config->get('remarketing_ecommerce_resend_status');
		}
		...
		if (isset($this->request->post['remarketing_ecommerce_delete_status'])) {
			$data['remarketing_ecommerce_delete_status'] = $this->request->post['remarketing_ecommerce_delete_status'];
		} else {
			$data['remarketing_ecommerce_delete_status'] = $this->config->get('remarketing_ecommerce_delete_status');
		}
		...
		if (isset($this->request->post['remarketing_ecommerce_send_status'])) {
			$data['remarketing_ecommerce_send_status'] = $this->request->post['remarketing_ecommerce_send_status'];
		} elseif ($this->config->get('remarketing_ecommerce_send_status')) {
			$data['remarketing_ecommerce_send_status'] = $this->config->get('remarketing_ecommerce_send_status');
		} else {
			$data['remarketing_ecommerce_send_status'] = [];
		}
		...
		if (isset($this->request->post['remarketing_telegram_message'])) {
			...
			$data['remarketing_telegram_message'] = "Имя: {firstname}
Фамилия: {lastname}
Email: {email}
Телефон: {telephone}
...
{products}";
	...
	protected function checkConfig() {
		...
		if ($this->config->get('remarketing_status')) {
			...
			if ($this->config->get('remarketing_ecommerce_ga4_status')) {
				$check .= '<b>' . $this->language->get('entry_ecommerce_ga4_identifier') . '</b>: <span>' . $this->config->get('remarketing_ecommerce_ga4_identifier') . '</span><br>';
			...
			$check .= '<br><br><b class="summary-heading">' . $this->language->get('text_ecommerce_ga4_measurement') . ' ' . ($this->config->get('remarketing_ecommerce_ga4_measurement_status') ? '<i class="fa fa-check" style="color:green"></i>' : '<i class="fa fa-times" style="color:red"></i>') . '</b><br>';

			if ($this->config->get('remarketing_ecommerce_ga4_measurement_status')) {
				$check .= '<b>' . $this->language->get('entry_ecommerce_ga4_analytics_id') . '</b>: <span>' . $this->config->get('remarketing_ecommerce_ga4_analytics_id') . '</span><br>';
				$check .= '<b>' . $this->language->get('entry_currency') . '</b>:  <span>' . $this->config->get('remarketing_ecommerce_currency') . '</span><br>';
			}
			...
			$check .= '<br><br><b class="summary-heading">' . $this->language->get('text_esputnik') . ' ' . ($this->config->get('remarketing_esputnik_status') ? '<i class="fa fa-check" style="color:green"></i>' : '<i class="fa fa-times" style="color:red"></i>') . '</b><br>';
			$check .= '<br><br><b class="summary-heading">' . $this->language->get('text_retail_rocket') . ' ' . ($this->config->get('remarketing_retailrocket_status') ? '<i class="fa fa-check" style="color:green"></i>' : '<i class="fa fa-times" style="color:red"></i>') . '</b><br>';
			$check .= '<br><br><b class="summary-heading">' . $this->language->get('text_tiktok') . ' ' . ($this->config->get('remarketing_tiktok_status') ? '<i class="fa fa-check" style="color:green"></i>' : '<i class="fa fa-times" style="color:red"></i>') . '</b><br>';
			$check .= '<br><br><b class="summary-heading">' . $this->language->get('text_telegram') . ' ' . ($this->config->get('remarketing_telegram_status') ? '<i class="fa fa-check" style="color:green"></i>' : '<i class="fa fa-times" style="color:red"></i>') . '</b><br>';
	...
	protected function getStatistics() {
		...
		$orders_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "remarketing_orders` ORDER BY order_id DESC");
		$i = 0;
		$parameters = [
		...
		foreach ($parameters as $parameter) {
			...
			if ($utms_query->num_rows) {
				foreach($utms_query->rows as $row) {
					$utm_count = $this->db->query("SELECT COUNT(" . $parameter . ") as total FROM `" . DB_PREFIX . "remarketing_orders` WHERE `" . $parameter . "` = '" . $row[$parameter] . "'")->row['total'];
					$utm[$parameter][] = [
						'value' => $row[$parameter],
						'count' => $utm_count
					];
