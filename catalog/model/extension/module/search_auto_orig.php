...
class ModelExtensionModuleSearchAuto extends Model{
    ...
    public function getAttributes(){
        ...
        if( !$attributes ){
            ...
            $sql = "SELECT pa.attribute_id, pa.text FROM " . DB_PREFIX . "category_path cp
                ...
                WHERE pa.language_id='" . (int) $this->config->get("config_language_id") . "' AND p.status='1'
    ...
    public function getTotalProducts($data)
    {
        ...
        foreach( $data["attr"] as $name => $value )
        {
            ...
            if( isset($value) && isset($config_value) )
            {
                $sql .= " LEFT JOIN " . DB_PREFIX . "product_attribute pa" . (int) $config_value . " ON (p.product_id=pa" . (int) $config_value . ".product_id AND pa" . (int) $config_value . ".attribute_id='" . (int) $config_value . "')";
            }
