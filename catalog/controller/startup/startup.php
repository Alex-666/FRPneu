...
class ControllerStartupStartup extends Controller {
    public function index() {
        ...
        if (isset($this->session->data['language']) && !array_key_exists($code, $languages) ) {
        ...
        if (isset($_GET['currency']) && !array_key_exists($code, $currencies)) {
            $code = $_GET['currency'];
        }

        if (isset($this->session->data['currency'])  && !array_key_exists($code, $currencies)) {
        ...
        if(isset($_GET['currency']) || isset($_GET['language']) ){
            ...
            unset($qsvars['currency']);
            unset($qsvars['language']);
            $newqs = http_build_query($qsvars);
            $redirect_url = $urlpart;
            if(!empty($newqs)){
                $redirect_url .= '?' . $newqs;
            }
