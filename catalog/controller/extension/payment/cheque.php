...
class ControllerExtensionPaymentCheque extends Controller {
    ...
    public function confirm() {
        ...
        if ($this->session->data['payment_method']['code'] == 'cheque') {
            ...
            $comment  = 'Vaše objednávka byla přijata, o výsledku Vás budeme kontaktovat na vámi uvedené telefonní číslo: ' . $order_info['telephone'] . ' a e-mailovou adresu: ' . $order_info['email'];
