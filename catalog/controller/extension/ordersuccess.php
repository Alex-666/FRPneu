<?php
class ControllerExtensionOrderSuccess extends Controller {
	public function index() {
		$this->load->language('extension/ordersuccess');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/ordersuccess')
		);
		...
		$data['invoice'] = $this->url->link('extension/ordersuccess/invoice', '&order_id=' . (int)$this->request->get['order_id'], true);	
		...
		$ordersucess_product=$this->config->get('ordersucess_product');
		if (!empty($ordersucess_product)) {
		...
		$this->response->setOutput($this->load->view('extension/ordersuccess', $data));
		}
