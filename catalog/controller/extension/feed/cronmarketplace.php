...
*/
    public function index()
    {
        ...
        $query = $this->db->query("SELECT DISTINCT `product_id` FROM `" . DB_PREFIX . "product` WHERE location = 'pohoda' AND LENGTH(TRIM(model)) > 0 AND LENGTH(image) > 0 AND status = 1 AND quantity > 3 ");
