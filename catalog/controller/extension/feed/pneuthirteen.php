...
class ControllerExtensionFeedPneuThirteen extends Controller
{
...
/*
            ...
            //if ($product['image'] && trim($product['model']) != '') {
                ...
                */
                ...
                if ($product['special']) {
                    ...
                    $output .= '<PRICE_NOVAT>' . round($this->tax->calculate($product['price'], 0)*0.88) . '</PRICE_NOVAT>';
                    $output .= '<PRICE_VAT>' . round($this->tax->calculate($product['price'], $product['tax_class_id'])*0.88) . '</PRICE_VAT>';
                }
        ...
        $file3 = $basedir . 'pneuthirteen_time.xml';
        $fp3 = fopen($file3, "w9");
        fwrite($fp3, $finish);
        fclose($fp3);
        echo "ok";
