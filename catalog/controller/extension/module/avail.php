...
class ControllerExtensionModuleAvail extends Controller
{
    ...
    public function save()
    {
        ...
        if (isset($this->error['error_minprice'])) {
            $json['error_minprice'] = $this->error['error_minprice'];
        } else {
            $json['error_minprice'] = '';
        }       
    ...
    public function validate()
    {
        ...
        if (isset($this->request->post['snizhen']) && (utf8_strlen($this->request->post['avail_arbitrary[0]']) < 1)) {
            $this->error['error_minprice'] = 'bad';
        }
