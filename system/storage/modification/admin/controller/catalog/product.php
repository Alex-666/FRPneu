	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
                ...
                'marze'      => $result['marze'],
                'sklad_tursko'   => $result['tursko'],
                'sklad_brno'   => $result['brno'],
...
//quicksave end
        ...
        if (isset($this->request->post['heureka_delivery_date'])) {
            $data['heureka_delivery_date'] = $this->request->post['heureka_delivery_date'];
        } elseif (!empty($product_info) AND $product_info['heureka_delivery_date'] != -1) {
            $data['heureka_delivery_date'] = $product_info['heureka_delivery_date'];
        } else {
            $data['heureka_delivery_date'] = '';
        }
        ...
        $data['sklad_tursko'] = $product_info['tursko'];
        $data['sklad_brno'] = $product_info['brno'];
