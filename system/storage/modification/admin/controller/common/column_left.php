...
if ($this->user->hasPermission('access', 'extension/module/cron')) {
   $marketplace[] = array(
      ...
      'children' => array()
			...
			if ($marketplace) {
                        ...
                        if (version_compare(VERSION,'3','<')) {
                            if ($this->user->hasPermission('access', 'extension/module/magicslideshow') && $rez->num_rows) {
                                $extension[] = array(
                                        'name'     => '<img style="width:32px; margin-bottom: -1px;" src="'.(defined('JCART_COMPONENT_URL') ? JCART_COMPONENT_URL.'admin/' : HTTPS_SERVER).'controller/extension/module/magicslideshow-opencart-module/magicslideshow.svg" /> Magic Slideshow',
                            ...
                            if ($this->user->hasPermission('access', 'extension/module/magicslideshow') && $rez->num_rows) {
                                $marketplace[] = array(
                                        'name'     => '<img style="width:32px; margin-bottom: -1px;" src="'.(defined('JCART_COMPONENT_URL') ? JCART_COMPONENT_URL.'admin/' : HTTPS_SERVER).'controller/extension/module/magicslideshow-opencart-module/magicslideshow.svg" /> Magic Slideshow',
                                        'href'     => $this->url->link('extension/module/magicslideshow', 'user_token=' . $this->session->data['user_token'], true),
                                        'children' => array()           
                                );
                            }
                        }					
        ...
        if (version_compare(VERSION, '3.0.0.0', '>=')) {
          $ocdevwizard[] = array(
            'name'     => $this->language->get('text_smart_checkout_upsell_pro_left_menu'),
            'href'     => $this->url->link('extension/ocdevwizard/smart_checkout_upsell_pro', 'user_token='.$this->session->data['user_token'].'&store_id=0', true),
            'children' => array()
          );
        } else {
          $ocdevwizard[] = array(
            'name'     => $this->language->get('text_smart_checkout_upsell_pro_left_menu'),
            'href'     => $this->url->link('extension/ocdevwizard/smart_checkout_upsell_pro', 'token='.$this->session->data['token'].'&store_id=0', true),
            'children' => array()
          );
        }
      ...
      if ($this->user->hasPermission('access', 'extension/module/gdpr')) {
    				$gdpr[] = array(
    					'name'	   => $this->language->get('text_gdpr_settings'),
    					'href'     => $this->url->link('extension/module/gdpr', 'user_token=' . $this->session->data['user_token'], true),
    					'children' => array()
    				);
    			}

    			if ($this->user->hasPermission('access', 'extension/report/customer_gdpr')) {
    				$gdpr[] = array(
    					'name'	   => $this->language->get('text_gdpr_report'),
    					'href'     => $this->url->link('report/report', 'user_token=' . $this->session->data['user_token'] . '&code=customer_gdpr', true),
    					'children' => array()
    				);
    			}
          ...
          if ($this->user->hasPermission('access', 'extension/report/customer_gdpr_policy')) {
            $gdpr[] = array(
              'name'	   => $this->language->get('text_gdpr_policy_accepted'),
              'href'     => $this->url->link('report/report', 'user_token=' . $this->session->data['user_token'] . '&code=customer_gdpr_policy', true),
              'children' => array()
            );
          }
          ...
          $data_breach_customers = array();

          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_customers')) {
            $data_breach_customers[] = array(
              'name'	   => $this->language->get('text_data_breach_customer_list'),
              'href'     => $this->url->link('extension/module/gdpr/report_breach_customers', 'user_token=' . $this->session->data['user_token'], true),
              'children' => array(),
            );
          }
          ...
          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_customers')) {
            $data_breach_customers[] = array(
              'name'	   => $this->language->get('text_data_breach_customer_emails'),
              'href'     => $this->url->link('extension/module/gdpr/report_breach_customers/getListOfEmailNotifications', 'user_token=' . $this->session->data['user_token'], true),
              'children' => array(),
            );
          }
          ...
          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_customers')) {
            $data_breach_customers[] = array(
              'name'	   => $this->language->get('text_data_breach_customer_emails_send'),
              'href'     =>  $data['data_breach_customer_emails_send'] = $this->url->link('extension/module/gdpr/report_breach_customers/sendEmails', 'user_token=' . $this->session->data['user_token'], true),
              'children' => array(),
            );
          }
          ...
          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_customers')) {
            $data_breach_customers[] = array(
              'name'	   => $this->language->get('text_data_breach_customer_csv'),
              'href'     => $data['data_breach_customer_csv'] = $this->url->link('extension/module/gdpr/report_breach_customers/getListOfCustomers', 'user_token=' . $this->session->data['user_token'], true),
              'children' => array(),
            );
          }
          ...
          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_commissioner')) {
            $data_breach[] = array(
              'name'	   => $this->language->get('text_data_breach_commissioner_form'),
              'icon' => 'fa-institution',
              'href'     => $this->url->link('extension/module/gdpr/report_breach_commissioner/form', 'user_token=' . $this->session->data['user_token'], true),
              'children' => array(),
            );
          }
          ...
          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_commissioner')) {
            $data_breach[] = array(
              'name'	   => $this->language->get('text_data_breach_commissioner_list'),
              'href'     => $this->url->link('extension/module/gdpr/report_breach_commissioner', 'user_token=' . $this->session->data['user_token'], true),
              'children' => array(),
            );
          }
          ...
          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_customers')) {
            $data_breach[] = array(
              'id' => 'menu-gdpr-customers',
              'icon' => 'fa-users',
              'name'	   => $this->language->get('text_customers'),
              'href'     => '',
              'children' => $data_breach_customers,
            );
          }

          if ($this->user->hasPermission('access', 'extension/module/gdpr/report_breach_commissioner')) {
            $gdpr[] = array(
              'name'	   => $this->language->get('text_data_breach'),
              'href'     => '',
              'children' => $data_breach,
            );
          }
          ...
          $this->load->language('common/column_left');
			...
			// Returns
                ...
                if ($this->user->hasPermission('access', 'extension/module/fast_comment_status')) {
                    $localisation[] = array(
                        'name'     => $this->language->get('text_fast_comment'),
                        'href'     => $this->url->link('extension/module/fast_comment_status', 'user_token=' . $this->session->data['user_token'], true),
                        'children' => array()
                    );
                }
