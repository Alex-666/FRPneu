...
class ControllerUserUserPermission extends Controller {
	...
	protected function getForm() {
        ...
        if (version_compare(VERSION, '2.2.0.0', '<=') && !in_array('extension/ocdevwizard/smart_checkout_upsell_pro', $data['permissions'])) {
          $data['permissions'][] = 'extension/ocdevwizard/smart_checkout_upsell_pro';
        }
