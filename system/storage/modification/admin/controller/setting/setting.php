...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
       $this->document->addScript('../admin/view/javascript/filemanager.js');
		...
		if (isset($this->request->post['config_oc_related_limit'])) {
	$data['config_oc_related_limit'] = $this->request->post['config_oc_related_limit'];
} elseif ($this->config->get('config_oc_related_limit')) {
	$data['config_oc_related_limit'] = $this->config->get('config_oc_related_limit');
} else {
	$data['config_oc_related_limit'] = 4;
}
