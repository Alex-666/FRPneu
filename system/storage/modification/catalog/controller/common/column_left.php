...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
        ...
        // start: OCdevWizard SMCHUP
        if (isset($part[0]) && isset($part[1]) && $part[0] == 'smart_checkout_upsell_pro') {
          $data['modules'][] = $this->load->controller('extension/ocdevwizard/'.$part[0].'_static', $smchup_form_data);
        }
        // end: OCdevWizard SMCHUP
        ...
        If ($route == 'product/category') {
            $data ['page_type'] = 'column-top';

        }else {
            $data ['page_type'] = 'column-left';
