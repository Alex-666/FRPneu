...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		$this->response->setOutput(magicRender($this->load->view('product/manufacturer_list', $data),$this,'manufacturers',(isset($results) ? $results : array())));
	}
			...
			foreach ($results as $result) {
				if ($result['image']) {
					$image = $this->model_tool_image->resize($result['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_product_height'));
                        ...
                        $image = $image .'" id="manufacturers_'.$result['product_id'].'"';
				} else {
 ...
 'avail_product_quantity'	  => $avail_product_quantity,
			...
			$this->response->setOutput(magicRender($this->load->view('product/manufacturer_info', $data),$this,'manufacturers',(isset($results) ? $results : array())));
		} else {
			$url = '';
